...
#define OTV_TRACE( s )                                     \
  ...
  /* use preprocessor's argument prescan to expand one argument into two */
#define OTV_NEST1( x )  OTV_NEST1_( x, 0 )
#define OTV_NEST1_( func0, name0 )        \
          FT_BEGIN_STMNT                  \
            valid->nesting_level = 0;     \
            valid->func[0]       = func0; \
  ...
  /* use preprocessor's argument prescan to expand two arguments into four */
#define OTV_NEST2( x, y )  OTV_NEST2_( x, 0, y, 0 )
#define OTV_NEST2_( func0, name0, func1, name1 ) \
          FT_BEGIN_STMNT                         \
            valid->nesting_level = 0;            \
            valid->func[0]       = func0;        \
  ...
  /* use preprocessor's argument prescan to expand three arguments into six */
#define OTV_NEST3( x, y, z )  OTV_NEST3_( x, 0, y, 0, z, 0 )
#define OTV_NEST3_( func0, name0, func1, name1, func2, name2 ) \
          FT_BEGIN_STMNT                                       \
            valid->nesting_level = 0;                          \
            valid->func[0]       = func0;                      \
...
#define ChainPosClassSet  otv_x_Ox
#define ChainPosRuleSet   otv_x_Ox
#define ChainSubClassSet  otv_x_Ox
#define ChainSubRuleSet   otv_x_Ox
#define JstfLangSys       otv_x_Ox
#define JstfMax           otv_x_Ox
#define LigGlyph          otv_x_Ox
#define LigatureArray     otv_x_Ox
#define LigatureSet       otv_x_Ox
#define PosClassSet       otv_x_Ox
#define PosRuleSet        otv_x_Ox
#define SubClassSet       otv_x_Ox
#define SubRuleSet        otv_x_Ox

  FT_LOCAL( void )
  otv_x_Ox ( FT_Bytes       table,
             OTV_Validator  valid );

#define AlternateSubstFormat1     otv_u_C_x_Ox
#define ChainContextPosFormat1    otv_u_C_x_Ox
#define ChainContextSubstFormat1  otv_u_C_x_Ox
#define ContextPosFormat1         otv_u_C_x_Ox
#define ContextSubstFormat1       otv_u_C_x_Ox
#define LigatureSubstFormat1      otv_u_C_x_Ox
#define MultipleSubstFormat1      otv_u_C_x_Ox

  FT_LOCAL( void )
  otv_u_C_x_Ox( FT_Bytes       table,
                OTV_Validator  valid );

#define AlternateSet     otv_x_ux
#define AttachPoint      otv_x_ux
#define ExtenderGlyph    otv_x_ux
#define JstfGPOSModList  otv_x_ux
#define JstfGSUBModList  otv_x_ux
#define Sequence         otv_x_ux

  FT_LOCAL( void )
  otv_x_ux( FT_Bytes       table,
            OTV_Validator  valid );

#define PosClassRule  otv_x_y_ux_sy
#define PosRule       otv_x_y_ux_sy
#define SubClassRule  otv_x_y_ux_sy
#define SubRule       otv_x_y_ux_sy

  FT_LOCAL( void )
  otv_x_y_ux_sy( FT_Bytes       table,
                 OTV_Validator  valid );

#define ChainPosClassRule  otv_x_ux_y_uy_z_uz_p_sp
#define ChainPosRule       otv_x_ux_y_uy_z_uz_p_sp
#define ChainSubClassRule  otv_x_ux_y_uy_z_uz_p_sp
#define ChainSubRule       otv_x_ux_y_uy_z_uz_p_sp

  FT_LOCAL( void )
  otv_x_ux_y_uy_z_uz_p_sp( FT_Bytes       table,
                           OTV_Validator  valid );

#define ContextPosFormat2    otv_u_O_O_x_Onx
#define ContextSubstFormat2  otv_u_O_O_x_Onx

  FT_LOCAL( void )
  otv_u_O_O_x_Onx( FT_Bytes       table,
                   OTV_Validator  valid );

#define ContextPosFormat3    otv_u_x_y_Ox_sy
#define ContextSubstFormat3  otv_u_x_y_Ox_sy

  FT_LOCAL( void )
  otv_u_x_y_Ox_sy( FT_Bytes       table,
                   OTV_Validator  valid );

#define ChainContextPosFormat2    otv_u_O_O_O_O_x_Onx
#define ChainContextSubstFormat2  otv_u_O_O_O_O_x_Onx

  FT_LOCAL( void )
  otv_u_O_O_O_O_x_Onx( FT_Bytes       table,
                       OTV_Validator  valid );

#define ChainContextPosFormat3    otv_u_x_Ox_y_Oy_z_Oz_p_sp
#define ChainContextSubstFormat3  otv_u_x_Ox_y_Oy_z_Oz_p_sp
