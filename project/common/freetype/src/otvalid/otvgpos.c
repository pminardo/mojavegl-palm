...
#define BaseArray       otv_x_sxy
#define LigatureAttach  otv_x_sxy
#define Mark2Array      otv_x_sxy
...
#define MarkBasePosFormat1  otv_u_O_O_u_O_O
#define MarkLigPosFormat1   otv_u_O_O_u_O_O
#define MarkMarkPosFormat1  otv_u_O_O_u_O_O
