...
static int get_decomposition( UNICODE_WCHAR src, UNICODE_WCHAR *dst, unsigned int dstlen )
{
    extern const UNICODE_WCHAR unicode_decompose_table[];
    const UNICODE_WCHAR *ptr = unicode_decompose_table;
    int res;
...
static __inline int check_invalid_chars_sbcs( const struct sbcs_table *table,
                                            const unsigned char *src, unsigned int srclen )
{
    const UNICODE_WCHAR * const cp2uni = table->cp2uni;
    while (srclen)
    {
...
static __inline int mbstowcs_sbcs( const struct sbcs_table *table,
                                 const unsigned char *src, unsigned int srclen,
                                 UNICODE_WCHAR *dst, unsigned int dstlen )
{
    const UNICODE_WCHAR * const cp2uni = table->cp2uni;
    int ret = srclen;
                                    ...
                                    UNICODE_WCHAR *dst, unsigned int dstlen )
{
    ...
    {
        UNICODE_WCHAR dummy[4]; /* no decomposition is larger than 4 chars */
...
static __inline int get_length_dbcs( const struct dbcs_table *table,
                                   const unsigned char *src, unsigned int srclen )
{
...
/* check src string for invalid chars; return non-zero if invalid char found */
static __inline int check_invalid_chars_dbcs( const struct dbcs_table *table,
                                            const unsigned char *src, unsigned int srclen )
{
    const UNICODE_WCHAR * const cp2uni = table->cp2uni;
    const unsigned char * const cp2uni_lb = table->cp2uni_leadbytes;
...
/* all lengths are in characters, not bytes */
static __inline int mbstowcs_dbcs( const struct dbcs_table *table,
                                 const unsigned char *src, unsigned int srclen,
                                 UNICODE_WCHAR *dst, unsigned int dstlen )
{
    const UNICODE_WCHAR * const cp2uni = table->cp2uni;
