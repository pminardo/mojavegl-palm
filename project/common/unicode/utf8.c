...
__inline static int get_length_wcs_utf8( const UNICODE_WCHAR *src, unsigned int srclen )
{
    int len;
...
/* query necessary dst length for src string */
__inline static int get_length_mbs_utf8( const unsigned char *src, int srclen )
{
    int ret;
